...
This dosimeter was originally created at the time of the Great East Japan Earthquake in 2011. The point of this repo is that it's calibrated using radioactive check sources, so dose estimation is possible from the readout. <BR>
もともとは2011年の東日本大震災の時に作成したものです。このリポジトリのポイントは、線量が標準線源で校正されていて、その見積もりか可能なことです。<BR><BR>
<IMG align="left" hspace="5" alt=Overall src="img/overall.png">
Overall view. It uses PIN photodiodes S6775 as detector. The upper left box contains the PIN photodiodes and electrically shields them from noises. Most gamma rays can be detected throught the shielding. X-rays below 50 keV or beta rays can be detected by drilling a hole at the front of the detectors and covering it with black paper or aluminum foil. A 9 V battery in the upper right corner is used as power source in this dosimeter to reduce noise. Counting is done by a PIC microcontroller in the lower half. The display is that of a prototype firmware and different from the current version. The overall size is approximately 115 x 80 x 25 mm.<BR>
...
<IMG align="left" hspace="5" alt=detector src="img/detector.png">
The detector case. Three PIN photodiodes S6775 are lined up on the left. They are covered with black tubing for shading. Black vinyl tape or similar will also work. Since this dosimeter deals with very small signals, the detector circuit must be electrically shielded. We used an aluminum case for it. Since the aluminum thickness is 1 mm, photons over 0.5 MeV can be detected through the case. So gamma rays of 662 keV of cesium 137 and 605 keV and 796 keV of cesium 134 can be measured. This photo was taken during production, so only five cables are shown, but we added another zero-potential cable as shown in the schematic below. The board is screwed with 5 mm spacers and grounded to the aluminum chassis.<BR>
...
The detector circuit is based on Hamamatsu Photonics' application note. Three PIN photodiodes are used in parallel to increase the detection area. Incident photon is converted into a voltage pulse by U1 and multiplied by 50 times by inverting amplifier U2. Frequency response depends on the characteristics of op amps (see LMC662 datasheet) and also on C3 (> 20 kHz). The output seems to be a pulse of 20 to 50 μsec at tens to over a hundred mV. When it exceeds the threshold (60 mV) set by VR1, the PIC is interrupted to convert the pulse with A/D and recoed its voltage. The dotted line part in the upper left corner is placed in an aluminum case to minimize noise interference. It's troublesome to place VR1 inside the case, though. Circuits of the PIC microcontroller, LCD, and USB connector are very standard. Circuit around the MOS FET is for switching battery power when USB bus power is supplied. If not necessary, connect Vout of U4 to Vcc and omit U5, D7, D8, CN2, 10 μF, 47 kΩ x2, and 10 kΩ x2. You can also omit circuits of RC0-RC2.<BR>
...
<tr><td>S-812C50AY</td><td>100 JPY / 8 pcs</td><td>Akidzuki, 78L05 compatible</td></tr>
<tr><td>2SJ680</td><td>50 JPY</td><td>Akidzuki, any enhanced Pch MOS FET will work.</td></tr>
<tr><td>S6775 x 3 pcs</td><td>@300 JPY x 3</td><td>Akidzuki</td></tr>
<tr><td>SD103A x 2 pcs</td><td></td><td>Any Schottky barrier will work.</td></tr>
<tr><td>1N4148</td><td></td><td>Any small signal D will work.</td></tr>
<tr><td>3 mm LED red/green, 1 each</td><td></td><td></td></tr>
<tr><td>LCD</td><td>SD1602HULB</td><td>900 JPY</td><td>Akidzuki. Its interface is HD44780.</td></tr>
<tr><td>Pin header</td><td>18 pins total</td><td></td><td></td></tr>
<tr><td>Xtal</td><td>20 MHz</td><td>200 JPY / 5 pcs</td><td>Akidzuki P-01757</td></tr>
<tr><td>Piezo speaker</td><td>PKM13EPYH4000-A0</td><td>30 JPY</td><td>Akidzuki. Any small piezo will work.</td></tr>
<tr><td rowspan=6>Capacitors</td><td>Ceramic 2 pF x 1</td><td></td><td></td></tr>
<tr><td>Ceramic 15 pF x 2</td><td></td><td></td></tr>
<tr><td>Film 470 pF x 1</td><td>10</td><td>Akidzuki P-15040</td></tr>
<tr><td>Ceramic 0.1 uF x 4</td><td></td><td>Film should work.</td></tr>
<tr><td>Film 0.1 uF x 2</td><td></td><td>C4, C5</td></tr>
<tr><td>Electrolytic 10 uF x 2</td><td></td><td></td></tr>
<tr><td>1/4W metal glaze resistor</td><td>10 MΩ x 1</td><td>55 JPY</td><td>Marutsu</td></tr>
<tr><td rowspan=8>1/4W carbon resistors</td><td>1 MΩ x 1</td><td></td><td></td></tr>
<tr><td>68 kΩ x 1</td><td></td><td>33 kΩ x 2 will work</td></tr>
<tr><td>47 kΩ x 2</td><td></td><td>33 kΩ is also ok</td></tr>
<tr><td>33 kΩ x 1</td><td></td><td></td></tr>
<tr><td>20 kΩ x 1</td><td></td><td>10 kΩ x2 will work</td></tr>
<tr><td>10 kΩ x 4</td><td></td><td></td></tr>
<tr><td>1 kΩ x 3</td><td></td><td>560 Ω should be ok.</td></tr>
<tr><td>560 Ω x 3</td><td></td><td></td></tr>
<tr><td>VR</td><td>5 kΩ x 1</td><td>50 JPY</td><td>Akidzuki P-14904</td></tr>
<tr><td rowspan=2>Switches</td><td>Tactile, 2P</td><td></td><td></td></tr>
<tr><td>Toggle, 6P or 3P</td><td>80</td><td>Akidzuki</td></tr>
...
<tr><td>Battery snap</td><td>006P (PP3)</td><td></td><td></td></tr>
<tr><td>Baterry</td><td>9V 006P</td><td></td><td></td></tr>
...
You may also need tools such as screwdriver, nippers, pliers, soldering iron + solder, drill, tester, PIC writer (PICkit etc) + PC + software (download).<BR>
...
Detection efficiency was examined by using check sources in the table below by placing them at 10 mm from the PIN photodiodes. The value is calculated from actual count / number of incident photons presumed from the decay of each radionuclide. The obtained efficiency is pretty low, but this is plausible because no fluorescent screen or scintillator is used in this dosimeter. The absorption coefficient of 662 keV gamma rays in 0.5 mm thick Si is calculated to be 0.0034 from the US NIST absorption coefficient (NIST Standard Reference Database 126), so the estimated efficiency is comparable to the theoretical vaule.<BR>
...
## Firmware ファームウエア
Please find source code and its hex under the <a href="https://github.com/mizutanilab/radiation-counter/tree/main/firmware">firmware</a> folder. Hostapp is also available. <BR>
ファームウエアは<a href="https://github.com/mizutanilab/radiation-counter/tree/main/firmware">firmware</a>フォルダに置きました。ホスト側のアプリもあります。

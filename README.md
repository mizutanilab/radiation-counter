...
The detector case. Three PIN photodiodes S6775 are lined up on the left. They are covered with black tubing for shading. Black vinyl tape or similar will also work. Since this dosimeter deals with very small signals, the detector circuit must be electrically shielded. We used an aluminum case. Since the aluminum thickness is 1 mm, photons over 0.5 MeV can be detected through the case. So gamma rays of 662 keV of cesium 137 and 605 keV and 796 keV of cesium 134 can be measured. This photo was taken during production, so only five cables are shown, but we added another zero-potential cable as shown in the schematic below. The board is screwed with 5 mm spacers and grounded to the aluminum chassis.<BR>
